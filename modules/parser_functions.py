...
settings = Config.load_file('set.json')
save_dir_path = settings.get('save_dir_path')
logging.basicConfig(filename=save_dir_path + '/mylog.log', filemode='w', level=logging.INFO)
            ...
            for k, v in update_dict.items():
                ...
                for row in v:
                    ...
                    try:
                        ...
                        logger.info(f'{item_url} {item_row}:{str(e)}')
                        pass
                driver.close()
